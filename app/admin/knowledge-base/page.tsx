    ...
    <div className="container mx-auto py-8 space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Upload and organize your golden documents to enhance AI-generated content quality
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Proposals, Audits, Reports, etc.</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Ready for seeding</p>
          </CardContent>
        </Card>
      </div>

      <Suspense fallback={<div>Loading knowledge base manager...</div>}>
